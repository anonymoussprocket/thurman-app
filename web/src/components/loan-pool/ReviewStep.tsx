...
import { Alert, Box, Button, Card, CardContent, Checkbox, Chip, Divider, FormControlLabel, Grid, Snackbar, Typography, CircularProgress } from '@mui/material';
...
export default function ReviewStep({ formMethods, onBack, uploadState, onSubmit, goToStep }: ReviewStepProps) {
  ...
  if (submitSuccess) {
    return (
      <Grid container spacing={3}>
        ...
        <Snackbar open={snackbarOpen} autoHideDuration={6000} onClose={handleSnackbarClose} anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }} aria-label='Success notification'>
  ...
  return (
    <Grid container spacing={3}>
        ...
        <Card sx={{ borderRadius: '1.25em' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
              ...
              <Button startIcon={<EditIcon />} onClick={() => goToStep(0)} sx={styles.button.text}>
                Edit
              </Button>
            </Box>
            <Divider sx={{ mb: 2 }} />
        ...
        <Card sx={{ borderRadius: '1.25em' }}>
          <CardContent>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
              ...
              <Button startIcon={<EditIcon />} onClick={() => goToStep(1)} sx={styles.button.text}>
                Edit
              </Button>
            </Box>
            <Divider sx={{ mb: 2 }} />
      ...
      {submitError && (
        <Grid item xs={12}>
          <Alert severity='error' sx={{ borderRadius: '1.25em' }} aria-live='assertive'>
            {submitError}
          </Alert>
        </Grid>
      )}
      ...
      <Grid item xs={12}>
        <FormControlLabel
          control={<Checkbox checked={termsAccepted} onChange={e => setTermsAccepted(e.target.checked)} sx={{ color: '#725aa2' }} inputProps={{ 'aria-label': 'Accept terms and conditions' }} />}
          label={
            <Typography variant='body2' sx={{ color: '#29262a' }}>
      ...
      <Snackbar open={snackbarOpen} autoHideDuration={6000} onClose={handleSnackbarClose} anchorOrigin={{ vertical: 'bottom', horizontal: 'center' }} aria-label={snackbarSeverity === 'success' ? 'Success notification' : 'Error notification'}>
        <Alert onClose={handleSnackbarClose} severity={snackbarSeverity} sx={{ borderRadius: '1.25em' }}>
          {snackbarMsg}
        </Alert>
      </Snackbar>
