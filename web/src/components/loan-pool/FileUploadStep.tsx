...
export default function FileUploadStep({ formMethods, onNext, onBack, uploadState }: StepProps) {
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        ...
        >
          ...
          <Button variant='contained' onClick={handleContinue} disabled={!canContinue || fileState?.isProcessing || false} sx={styles.button.primary}>
            Continue to Review
          </Button>
        </Box>
      </Grid>
