...
import { Box, Card, CardContent, Chip, CircularProgress, Grid, IconButton, Paper, Typography } from '@mui/material';
import CloudUploadIcon from '@mui/icons-material/CloudUpload';
import DeleteIcon from '@mui/icons-material/Delete';
import { useDropzone } from 'react-dropzone';
import { FileUploadProps } from '../../types/loan-pool';

export default function FileUploadZone({ onFileAccepted, onFileRejected, isProcessing, uploadedFile, previewData, onRemoveFile }: FileUploadProps) {
