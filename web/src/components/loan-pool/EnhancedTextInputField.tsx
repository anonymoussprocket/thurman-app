...
export default function EnhancedTextInputField({ control, name, rules, label, type, helperText, multiline = false, rows = 4, startAdornment, endAdornment }: EnhancedTextInputFieldProps) {
  ...
  const buildInputProps = () => {
    ...
    if (endAdornment) {
      ...
      inputProps.endAdornment = <PasswordAdornment handleClickShowPassword={handleClickShowPassword} showPassword={showPassword} />;
    }
