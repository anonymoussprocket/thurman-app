    ...
    <Paper sx={styles.pools.card}>
      ...
      >
        ...
        <Box>
          ...
          <Typography variant='h6'>{pool.loanTerm}</Typography>
        </Box>
        <Box>
          <Typography variant='body2' color='text.secondary'>
            Available Liquidity
          </Typography>
          <Typography variant='h6'>{pool.liquidity}</Typography>
        </Box>
        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
          <Button variant='contained' sx={styles.button.primary} onClick={() => onBrowse(pool.id)}>
            Browse Pool
          </Button>
        </Box>
      </Box>
