...
const authSteps: StepComponent<StepProps>[] = [StepOne, StepTwo];
...
export default function AuthOptions({ authType, options }: AuthOptionsProps) {
  ...
  return (
    <Grid container direction='column' spacing={2}>
      <Grid container direction='column' alignItems='center' sx={styles.containers.authOptionHeader}>
        {currentStepIndex > 0 && (
        ...
        <Avatar src={thurman} sx={styles.avatar.large} />
