...
import { Box, Button, Card, CardContent, Typography, Alert, CircularProgress, IconButton, Tooltip, Skeleton } from '@mui/material';
import { Refresh as RefreshIcon, AccountBalance as AccountBalanceIcon, TrendingUp as TrendingUpIcon, Warning as WarningIcon } from '@mui/icons-material';
...
export default function UserBalanceCard({ userAddress, onBalanceUpdate }: UserBalanceCardProps) {
