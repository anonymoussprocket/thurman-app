...
import { Button, Grid, Typography, Alert, CircularProgress, Box } from '@mui/material';
...
export default function EmailAuthForm({ authType }: EmailAuthFormProps) {
  ...
  const passwordRequirements = ['At least 8 characters', 'At least 1 uppercase letter', 'At least 1 lowercase letter', 'At least 1 number', 'At least 1 special character'];
                ...
                <Box sx={{ mt: 1 }}>
                  ...
                  <Box component='ul' sx={{ mt: 0.5, pl: 2 }}>
                    {passwordRequirements.map((requirement, index) => (
                      <Typography key={index} variant='caption' color='text.secondary' component='li' sx={{ fontSize: '0.75rem' }}>
                        {requirement}
                      </Typography>
                    ))}
                  </Box>
