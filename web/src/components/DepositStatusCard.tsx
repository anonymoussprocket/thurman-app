...
import { Box, Button, Card, CardContent, Typography, Alert, CircularProgress, Chip, Divider, Stack, Skeleton } from '@mui/material';
import { Pending as PendingIcon, CheckCircle as CheckCircleIcon, AccountBalance as AccountBalanceIcon, TrendingUp as TrendingUpIcon } from '@mui/icons-material';
...
export default function DepositStatusCard({ depositStatus, loading = false, poolId, poolName, onClaimSuccess, onClaimError }: DepositStatusCardProps) {
  ...
  return (
    ...
    >
      <CardContent>
        ...
        {/* Notification Alert */}
        {notification && (
          <Alert severity={notification.type} onClose={clearNotification} sx={{ mb: 3 }}>
