...
import { updateDepositState, DepositEvent, validateDepositEvent } from '../services/depositStateManager';
...
function processContractEvent(notification: CircleEventNotification): ProcessedEventData | null {
    ...
    if (POOL_MANAGER_CONTRACT_ADDRESS && contractEvent.contractAddress.toLowerCase() !== POOL_MANAGER_CONTRACT_ADDRESS) {
